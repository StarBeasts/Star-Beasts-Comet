...
EndTrainerBattle::
	...
	and a
	jr nz, .skipRemoveSprite ; test if trainer was fought (in that case skip removing 
				 ; the corresponding sprite)
	ld a, [wCurMap]
	cp POKEMON_TOWER_7F
	jr z, .skipRemoveSprite ; the two 7f scripts call EndTrainerBattle manually after
