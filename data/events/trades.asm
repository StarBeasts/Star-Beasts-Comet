...
; entries correspond to TRADE_FOR_* constants
	...
	db HAUNTER,    RHYDON,    TRADE_DIALOGSET_CASUAL,    "BLIND@@@@@@" ; implemented, not in new location yet (Military Base)
	...
	db JYNX,       EEVEE,     TRADE_DIALOGSET_EVOLUTION,    "ARIEL@@@@@@" ; implemented, not in new location yet (Kunzite Key)
	db MANKEY,     SQUIRTLE, TRADE_DIALOGSET_HAPPY,      "PRINCESS@@@" ; implemented, in new location
	db TENTACOOL,  HITMONLEE,   TRADE_DIALOGSET_HAPPY,  "ZOOK HERO@@" ; implemented, not in new location yet (Police Station)
