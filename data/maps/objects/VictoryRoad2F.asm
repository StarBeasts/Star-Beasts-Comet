VictoryRoad2F_Object:
	...
	object_event  3, 54, SPRITE_ROCKER, STAY, ANY_DIR, 3, OPP_TAMER, 5
	...
	object_event 13, 52, SPRITE_POKE_BALL, STAY, NONE, 7, FULL_RESTORE
	object_event 35, 48, SPRITE_POKE_BALL, STAY, NONE, 8, TM_DRAGON_CLAW
	object_event 24,  2, SPRITE_POKE_BALL, STAY, NONE, 9, MAX_ELIXER
