PokemonTower3F_Object:
	...
	def_object_events
	object_event 12,  8, SPRITE_CHANNELER, STAY, RIGHT, 1, OPP_CHANNELER, 5
	object_event  8,  6, SPRITE_CHANNELER, STAY, UP, 2, OPP_CHANNELER, 6
	object_event 11,  1, SPRITE_CHANNELER, STAY, DOWN, 3, OPP_CHANNELER, 8
	object_event  7,  4, SPRITE_POKE_BALL, STAY, NONE, 4, ESCAPE_ROPE
