Route4_Object:
	...
	def_bg_events
	bg_event 57,  7, 6 ; Route4Text5
	bg_event 37, 13, 7 ; Route4Text6
	bg_event 20, 11, 8 ; Route4Text7
	bg_event 53, 13, 9 ; Route4Text8
	bg_event 25, 11, 10 ; Route4Text9
	...
	object_event 35,  12, SPRITE_GAMBLER, STAY, DOWN, 5 ; person
