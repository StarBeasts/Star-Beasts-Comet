PokemonMansion2F_Object:
	...
	object_event  4,  5, SPRITE_PAPER, STAY, NONE, 3 ; person
	object_event  5,  5, SPRITE_PAPER, STAY, NONE, 4 ; person
	object_event  6,  5, SPRITE_PAPER, STAY, NONE, 5 ; person
	object_event  7,  5, SPRITE_PAPER, STAY, NONE, 6 ; person
