RocketHideoutB1F_Object:
	...
	def_object_events
	object_event 24, 20, SPRITE_PSYCHIC, STAY, RIGHT, 1, OPP_ROCKET, 8
	object_event 32, 14, SPRITE_PSYCHIC, STAY, DOWN, 2, OPP_ROCKET, 9
	object_event 17, 14, SPRITE_PSYCHIC, STAY, UP, 3, OPP_ROCKET, 10
	object_event 21, 12, SPRITE_PSYCHIC, STAY, DOWN, 4, OPP_ROCKET, 11
	object_event 28, 10, SPRITE_PSYCHIC, STAY, LEFT, 5, OPP_ROCKET, 12
