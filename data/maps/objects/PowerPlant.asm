PowerPlant_Object:
	...
	object_event 24, 14, SPRITE_CHEST, STAY, NONE, 10, CARBOS
	object_event 16, 18, SPRITE_CHEST, STAY, NONE, 11, HP_UP
	object_event 38, 28, SPRITE_CHEST, STAY, NONE, 12, RARE_CANDY
	object_event  8, 10, SPRITE_CHEST, STAY, NONE, 13, TM_THUNDER
	object_event 18, 22, SPRITE_CHEST, STAY, NONE, 14, TM_REFLECT
