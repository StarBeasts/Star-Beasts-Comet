Route10_Object:
	...
	def_object_events
	object_event  8,  4, SPRITE_YOUNGSTER, STAY, RIGHT, 1, OPP_YOUNGSTER, 4
	object_event 11,  6, SPRITE_HIKER, STAY, LEFT, 2, OPP_HIKER, 7
	object_event  8,  9, SPRITE_JUSTIN, STAY, RIGHT, 3, OPP_POKEMANIAC, 2
	object_event 11, 12, SPRITE_COOLTRAINER_F, STAY, LEFT, 4, OPP_LASS, 11
