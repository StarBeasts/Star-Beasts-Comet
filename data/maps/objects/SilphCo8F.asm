SilphCo8F_Object:
	...
	object_event 11,  7, SPRITE_CHEST, STAY, DOWN, 5 ; person
	object_event 15,  7, SPRITE_CHEST, STAY, DOWN, 5 ; person
	object_event  8,  7, SPRITE_CHEST, STAY, DOWN, 5 ; person
	object_event  3,  7, SPRITE_CHEST, STAY, DOWN, 5 ; person
