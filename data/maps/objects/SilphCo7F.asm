SilphCo7F_Object:
	...
	object_event 16,  3, SPRITE_ROCKET, STAY, LEFT_RIGHT, 5, OPP_ROCKET, 32
	object_event 21,  8, SPRITE_SCIENTIST, STAY, LEFT, 6, OPP_SCIENTIST, 8
	object_event 15,  7, SPRITE_ROCKET, STAY, LEFT_RIGHT, 7, OPP_ROCKET, 33
	object_event 20,  3, SPRITE_ROCKET, STAY, LEFT_RIGHT, 8, OPP_ROCKET, 34
	object_event  3,  7, SPRITE_BLUE, STAY, UP, 9 ; person
	object_event 15, 10, SPRITE_POKE_BALL, STAY, NONE, 10, CALCIUM
	object_event 22,  9, SPRITE_POKE_BALL, STAY, NONE, 11, TM_SWORDS_DANCE
