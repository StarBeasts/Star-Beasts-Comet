FuchsiaGym_Object:
	...
	object_event  5, 23, SPRITE_FISHER, STAY, DOWN, 2, OPP_JUGGLER, 7
	object_event 47, 53, SPRITE_FISHER, STAY, DOWN, 3, OPP_JUGGLER, 3
	object_event 37, 47, SPRITE_FISHER, STAY, UP, 4, OPP_JUGGLER, 8
	object_event 21, 35, SPRITE_ROCKER, STAY, RIGHT, 5, OPP_TAMER, 1
	object_event 21,  8, SPRITE_ROCKER, STAY, DOWN, 6, OPP_TAMER, 2
	object_event 29,  8, SPRITE_FISHER, STAY, UP, 7, OPP_JUGGLER, 4
