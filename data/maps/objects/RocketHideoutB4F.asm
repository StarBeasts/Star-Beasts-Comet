RocketHideoutB4F_Object:
	...
	def_warp_events
	warp_event  0,  9, ROCKET_HIDEOUT_B1F, 3
	warp_event  3,  3, VULT_MAZE, 2
	warp_event 12, 23, ROCKET_HIDEOUT_B3F, 2
	warp_event 13, 23, ROCKET_HIDEOUT_B3F, 2

	def_bg_events

	def_object_events
	object_event 14, 13, SPRITE_DAISY, STAY, DOWN, 1, OPP_SABRINA, 2
	object_event  6,  4, SPRITE_PSYCHIC, STAY, UP, 2, OPP_PSYCHIC_TR, 10
	object_event  6,  2, SPRITE_PSYCHIC, STAY, DOWN, 3, OPP_PSYCHIC_TR, 11
	object_event 14,  7, SPRITE_CHANNELER, STAY, DOWN, 4, OPP_CHANNELER, 11
	object_event 27,  2, SPRITE_POKE_BALL, STAY, NONE, 5, REVIVE
	object_event  3,  7, SPRITE_POKE_BALL, STAY, NONE, 6, TM_HURRICANE
	object_event  4, 21, SPRITE_POKE_BALL, STAY, NONE, 7, HP_UP
