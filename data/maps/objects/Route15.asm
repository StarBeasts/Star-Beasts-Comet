Route15_Object:
	...
	object_event 15, 17, SPRITE_OFFICER, STAY, ANY_DIR, 3, OPP_BIRD_KEEPER, 6
	object_event 37,  9, SPRITE_OFFICER, STAY, UP_DOWN, 4, OPP_BIRD_KEEPER, 7
	...
	object_event 48, 14, SPRITE_BIKER, STAY, DOWN, 7, OPP_BIKER, 3
	...
	object_event 19, 10, SPRITE_LORELEI, STAY, DOWN, 10, OPP_LORELEI, 1
