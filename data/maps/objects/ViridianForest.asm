ViridianForest_Object:
	...
	object_event 25, 33, SPRITE_YOUNGSTER, STAY, LEFT, 2, OPP_BUG_CATCHER, 1
	object_event 45, 30, SPRITE_YOUNGSTER, STAY, LEFT, 3, OPP_BUG_CATCHER, 2
	object_event 27,  7, SPRITE_MONSTER, STAY, LEFT, 4, OPP_POKEMANIAC, 8
	object_event 10, 16, SPRITE_YOUNGSTER, STAY, LEFT, 5, OPP_BUG_CATCHER, 3
	object_event 35, 25, SPRITE_COOLTRAINER_F, STAY, LEFT, 6, OPP_LASS, 19
	object_event 19, 32, SPRITE_POKE_BALL, STAY, NONE, 7, ANTIDOTE
