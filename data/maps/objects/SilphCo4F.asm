SilphCo4F_Object:
	...
	object_event 24, 11, SPRITE_POKE_BALL, STAY, NONE, 5, FULL_HEAL
	object_event 24,  9, SPRITE_POKE_BALL, STAY, NONE, 6, MAX_REVIVE
	object_event 24, 10, SPRITE_POKE_BALL, STAY, NONE, 7, ESCAPE_ROPE
