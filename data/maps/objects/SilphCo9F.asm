SilphCo9F_Object:
	...
	object_event 13,  7, SPRITE_COOLTRAINER_M, STAY, RIGHT, 2, OPP_COOLTRAINER_M, 7
	object_event  9, 16, SPRITE_COOLTRAINER_F, STAY, LEFT, 3, OPP_COOLTRAINER_F, 8
	object_event 20,  3, SPRITE_COFFEE, STAY, DOWN, 4, TENTACRUEL, 34 | OW_POKEMON
