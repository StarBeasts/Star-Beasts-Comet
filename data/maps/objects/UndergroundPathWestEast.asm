UndergroundPathWestEast_Object:
	...
	def_bg_events
	bg_event 8, 2, 13 ; Route18Text12
	bg_event 9, 2, 14 ; Route18Text13
	...
	object_event 15,  5, SPRITE_OFFICER, STAY, RIGHT, 5 ; person
	object_event 18,  3, SPRITE_OFFICER, STAY, LEFT, 6 ; person
	object_event 18,  6, SPRITE_ROCKET, STAY, ANY_DIR, 7 ; person
	...
	object_event 15,  14, SPRITE_CLIPBOARD, STAY, DOWN, 12 ; person
