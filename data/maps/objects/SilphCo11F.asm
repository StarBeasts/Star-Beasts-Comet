SilphCo11F_Object:
	...
	object_event  5, 14, SPRITE_MIDDLE_AGED_MAN, STAY, RIGHT, 4, OPP_CUE_BALL, 12
	object_event 11,  1, SPRITE_ROCKET, STAY, LEFT, 5, OPP_ROCKET, 40
