Route20_Object:
	...
	def_object_events
	object_event 9, 80, SPRITE_SWIMMER, STAY, LEFT_RIGHT, 1, OPP_SWIMMER, 9
	object_event 3, 47, SPRITE_SWIMMER, STAY, DOWN, 2, OPP_BEAUTY, 15
	object_event  5, 27, SPRITE_SWIMMER, STAY, DOWN, 3, OPP_BEAUTY, 6
	object_event 10, 24, SPRITE_SWIMMER, WALK, LEFT_RIGHT, 4, OPP_TAMER, 7
	object_event  9, 33, SPRITE_SWIMMER, STAY, DOWN, 5, OPP_SWIMMER, 10
	object_event 14, 21, SPRITE_SWIMMER, STAY, DOWN, 6, OPP_SWIMMER, 11
