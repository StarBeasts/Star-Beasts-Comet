...
BlkPacket_Battle:
	...
	ATTR_BLK_DATA %011, 1,1,0, 00,00, 10,03 ; enemy HP bar: pal 1
	ATTR_BLK_DATA %011, 0,0,0, 11,07, 19,11 ; player HP bar: pal 0
	ATTR_BLK_DATA %011, 2,2,0, 00,04, 10,11 ; player mon: pal 2
...
BlkPacket_Pokedex:
	ATTR_BLK 1
	ATTR_BLK_DATA %111, 1,1,0, 02,01, 08,07 ; mon: pal 1, everything else: pal 0
	ds 8, 0
...
BlkPacket_Titlescreen:
	...
	ATTR_BLK_DATA %011, 1,1,0, 02,03, 18,05 ; Logo
	ATTR_BLK_DATA %010, 1,1,0, 00,17, 19,17 ; Year

	ATTR_BLK_DATA %010, 1,1,0, 00,00, 04,00 ; Cloud1
	ATTR_BLK_DATA %010, 1,1,0, 06,06, 10,06 ; Cloud2
	ATTR_BLK_DATA %010, 1,1,0, 12,00, 18,01 ; Cloud3
...
BlkPacket_TrainerCard:
	...
	ATTR_BLK_DATA %010, 1,1,0, 15,14, 16,16 ; Earth Badge
	ATTR_BLK_DATA %011, 2,2,0, 04,01, 07,04 ; Boulder Badge
	ds 2, 0
...
PalPacket_TrainerCard:    PAL_SET PAL_BORDER, PAL_BADGE, PAL_REDMON, PAL_YELLOWMON
...
PalPacket_Border:         PAL_SET PAL_BORDER, PAL_DEX_CRYSTAL, 0, 0
