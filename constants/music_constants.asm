...
;ENDM
	...
	const MUSIC_BLUE
	const MUSIC_WILD_ENCOUNTER
	const MUSIC_ROCKET_BATTLE
	const MUSIC_MEOWTH_STAGE
	const MUSIC_IMAKUNI_2
	const MUSIC_DUEL_THEME_1
	const MUSIC_DUEL_THEME_3
	const MUSIC_HERO
	const MUSIC_ACADEMY
	const MUSIC_UNATCO
	const MUSIC_SADALEX
	...
	const MUSIC_SWEET_VICTORY
	const MUSIC_EZIO
	const MUSIC_HOTDRINKS
	const MUSIC_SAFARI_ROUTE
	const MUSIC_MISERITE
	const MUSIC_THOUSAND
	const MUSIC_CHAMBER
	const MUSIC_HILL
	const MUSIC_DINER
	const MUSIC_DRUNKEN
	const MUSIC_SIXTEEN_TONS
	const MUSIC_CHAINS
	const MUSIC_SEWERS
	const MUSIC_ONWARD
	const MUSIC_VARIK
	const MUSIC_GADOBA
	const MUSIC_BURNTLAB
	const MUSIC_REAPER
	const MUSIC_LAW_ORDER
	const MUSIC_BEAT_IT
	const MUSIC_TOUHOU
	const MUSIC_X_ISLE
	const MUSIC_BRIDGE
	const MUSIC_ELYSYANN
	const MUSIC_RUINS_RADIO
	const MUSIC_ROCKET_RADIO
	const MUSIC_MOBILE_ADAPTER_MENU
	const MUSIC_ROCKET_THEME
	const MUSIC_QUARTZ_QUARRY
