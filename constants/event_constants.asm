...
; S.S. Anne events
	const_next $5C0
	const_skip 1
	const EVENT_BEAT_SS_ANNE_3_TRAINER_0
	const EVENT_BEAT_SS_ANNE_3_TRAINER_1
	const_skip 1
...
; Villa
	...
	const EVENT_BEAT_VILLA_2F_TRAINER_0
	...
	const EVENT_BEAT_CELADON_MANSION_2F_TRAINER_0
	const EVENT_BEAT_ROUTE_8_GATE_TRAINER_0
	const EVENT_BEAT_CINNABAR_LAB_TRADE_ROOM_TRAINER_0
	const EVENT_GOT_BARBARA
	const EVENT_BEAT_HOVERPOP
	const EVENT_BOUGHT_CHARCOLD
