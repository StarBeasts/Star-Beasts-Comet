...
; SpriteSheetPointerTable indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_JUSTIN
	const SPRITE_CUE_BALL
	const SPRITE_WIFE
	const SPRITE_SHERIFF
	const SPRITE_REMNANT
	const SPRITE_SUBROSIAN_ALT
	const SPRITE_DRAGON
...
DEF FIRST_STILL_SPRITE EQU const_value
	...
	const SPRITE_URN
	const SPRITE_MAP
	const ICON_ANGEL_SPRITE
	const ICON_BALL_SPRITE
	const ICON_BLOB_SPRITE
	const ICON_FIRE_SPRITE
	const ICON_GHOST_SPRITE
	const ICON_GRASS_SPRITE
	const ICON_HUMAN_SPRITE
	const ICON_WATER_SPRITE
	const ICON_QUADRUPED_SPRITE
	const ICON_DRAGON_SPRITE
	const ICON_MONSTER_SPRITE
	const ICON_SNAKE_SPRITE
