...
Route14TrainerHeader0:
	trainer EVENT_BEAT_ROUTE_14_TRAINER_0, 3, Route14BattleText1, Route14EndBattleText1, Route14AfterBattleText1
Route14TrainerHeader1:
	trainer EVENT_BEAT_ROUTE_14_TRAINER_1, 3, Route14BattleText2, Route14EndBattleText2, Route14AfterBattleText2
Route14TrainerHeader2:
	trainer EVENT_BEAT_ROUTE_14_TRAINER_2, 3, Route14BattleText3, Route14EndBattleText3, Route14AfterBattleText3
...
Route14TrainerHeader6:
	trainer EVENT_BEAT_ROUTE_14_TRAINER_6, 3, Route14BattleText7, Route14EndBattleText7, Route14AfterBattleText7
Route14TrainerHeader7:
	trainer EVENT_BEAT_ROUTE_14_TRAINER_7, 3, Route14BattleText8, Route14EndBattleText8, Route14AfterBattleText8
...
Route14TrainerHeader9:
	trainer EVENT_BEAT_ROUTE_14_TRAINER_9, 3, Route14BattleText10, Route14EndBattleText10, Route14AfterBattleText10
	db -1 ; end
